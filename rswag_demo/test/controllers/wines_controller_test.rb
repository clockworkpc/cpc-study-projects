...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { grapes: @wine.grapes, name: @wine.name, type: @wine.type } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { grapes: @wine.grapes, name: @wine.name, type: @wine.type } }
